...
-   This endpoint must raise a 401 error by using  `abort`  -  [Custom Error Pages](https://intranet.hbtn.io/rltoken/_0XkgV2FAt-cM23Zg8G0OA "Custom Error Pages")
...
-   This endpoint must raise a 403 error by using  `abort`  -  [Custom Error Pages](https://intranet.hbtn.io/rltoken/_0XkgV2FAt-cM23Zg8G0OA "Custom Error Pages")
...
Now the biggest piece is the filtering of each request. For that you will use the Flask method  [before_request](https://intranet.hbtn.io/rltoken/k9NBPU-oNYWbwWfEOAW7aA "before_request")
