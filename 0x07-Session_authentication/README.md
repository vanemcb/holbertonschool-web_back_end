...
Copy all your work of the  [0x06. Basic authentication](https://intranet.hbtn.io/rltoken/mvRC9T8GQgfTWhinVKGUzQ "0x06. Basic authentication")  project in this new folder.
...
-   Retrieve the  `User`  instance based on the  `email`  - you must use the class method  `search`  of  `User`  (same as the one used for the  `BasicAuth`)
    ...
    -   Otherwise, create a Session ID for the  `User`  ID:
        ...
        -   You must set the cookie to the response - you must use the value of the environment variable  `SESSION_NAME`  as cookie name -  [tip](https://intranet.hbtn.io/rltoken/2sjTHzlZoVJVGTSjfOFVmQ "tip")
